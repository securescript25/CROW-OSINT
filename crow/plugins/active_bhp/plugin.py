"""
bhp/plugin.py - Black Hat Python Cybernetic Reconnaissance Plugin
بلوقين موحد متطور مع ميزات متقدمة للمسح الشامل + نظام تصفية المنافذ
"""
...
class PortScanResult:
    """نتائج مسح المنفذ مع دعم التصفية"""
    plugin: str
    port: int
    protocol: str = "tcp"
    ...
    should_display: bool = True  # 🔥 جديد: التحكم في العرض
